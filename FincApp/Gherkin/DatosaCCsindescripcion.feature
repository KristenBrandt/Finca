Feature: Ingreso de datos a los Centros de Costo
	...
	Quiero poder ingresar el costo y de la compra hecha sin descripcion
...
Scenario: Ingreso de datos al CC con descripcion
	...
	When el administrador ingresa el costo, el nombre del articulo o servicio comprado y a que centro de costo pertenece
